# Based on Django core/management/__init__.py file
...
def get_commands():
    ...
    calls.
    """
    commands = {name: 'staticsites' for name in find_commands(__path__[0])}
        ...
        if commands_only:
            ...
            if self.settings_exception is not None:
                usage.append(style.NOTICE(
                    "Note that only django-static-sites core commands are listed "
